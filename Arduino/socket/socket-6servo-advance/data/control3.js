   ...
   //   console.log('Server: ', e.data);
    ...
    function sendServo(){
      ...
      var S3 = parseInt(document.getElementById('S3').value).toString(16);
      var S4 = parseInt(document.getElementById('S4').value).toString(16);    
	...
	function S6Up(){
		//document.getElementById('S6').value=90;
		sendServo();
	}

	function S5Up(){
		//document.getElementById('S5').value=90;
		sendServo();
	}

	function S4Up(){
		//document.getElementById('S4').value=90;
		sendServo();
	}
